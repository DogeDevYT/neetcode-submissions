...
private:
    int ROWS;
    int COLS; 
    void ff_bfs(vector<vector<char>>& board, int row, int col) 
    {
...
public:
    void solve(vector<vector<char>>& board) {
        ...
        {
            //top row
            if (board[0][c] == 'O') ff_bfs(board, 0, c);
            //bottom row
            if (board[ROWS - 1][c] == 'O') ff_bfs(board, ROWS - 1, c);
        }
        ...
        {
            //left row
            if (board[r][0] == 'O') ff_bfs(board, r, 0);
            //right row
            if (board[r][COLS - 1] == 'O') ff_bfs(board, r, COLS - 1);
        }
